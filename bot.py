...
async def restore_from_jsonbin():
    ...
    for u in data.get("users", []):
        c.execute("""INSERT OR IGNORE INTO users
            ...
            VALUES (?,?,?,?,?,?,?,?)""",
            (u.get("user_id"), u.get("full_name",""), u.get("username",""),
             u.get("join_date",""), u.get("posted_ads",0), u.get("paid_slots",0),
             u.get("pending_approval",0), u.get("free_ad_used",0)))

    # Channels
    c.execute("DELETE FROM channels")
    for ch in data.get("channels", []):
        c.execute("INSERT OR IGNORE INTO channels (channel_id, url) VALUES (?,?)",
                  (ch.get("channel_id"), ch.get("url")))
    ...
    for o in data.get("uc_orders", []):
        c.execute("""INSERT OR IGNORE INTO uc_orders
            ...
            VALUES (?,?,?,?,?,?,?,?,?,?,?,?)""",
            (o.get("id"), o.get("user_id"), o.get("full_name",""), o.get("username",""),
             o.get("uc_amount"), o.get("price"), o.get("pubg_id",""),
             o.get("screenshot_id"), o.get("status","pending"),
             o.get("payment_method","manual"), o.get("payment_id",0), o.get("order_date","")))

    # Stars orders
    for o in data.get("stars_orders", []):
        c.execute("""INSERT OR IGNORE INTO stars_orders
            ...
            VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)""",
            (o.get("id"), o.get("user_id"), o.get("full_name",""), o.get("username",""),
             o.get("stars_amount"), o.get("price"), o.get("target_type","me"),
             o.get("target_username",""), o.get("receipt_id"), o.get("status","pending"),
             o.get("payment_method","manual"), o.get("payment_id",0), o.get("order_date","")))

    # Premium orders
    for o in data.get("premium_orders", []):
        c.execute("""INSERT OR IGNORE INTO premium_orders
            ...
            VALUES (?,?,?,?,?,?,?,?,?,?,?,?)""",
            (o.get("id"), o.get("user_id"), o.get("full_name",""), o.get("username",""),
             o.get("duration",""), o.get("price"), o.get("target_username",""),
             o.get("receipt_id"), o.get("status","pending"),
             o.get("payment_method","manual"), o.get("payment_id",0), o.get("order_date","")))
    ...
    for p in data.get("pending_payments", []):
        c.execute("""INSERT OR IGNORE INTO pending_payments
            ...
            VALUES (?,?,?,?,?,?,?,?,?,?)""",
            (p.get("id"), p.get("payment_id",0), p.get("user_id"), p.get("full_name",""),
             p.get("username",""), p.get("amount"), p.get("type","ad"),
             p.get("status","pending"), p.get("created_at",""), p.get("order_data","{}")))
